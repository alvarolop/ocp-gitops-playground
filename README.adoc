...
[source, bash]
----
oc process -f openshift/gitops-01-operator.yaml | oc apply -f -
----
...
[source, bash]
----
oc process -f openshift/gitops-02-argocd.yaml | oc apply -f -
----
...
[source, bash]
----
oc process -f openshift/gitops-03-application-app.yaml | oc apply -f -
----
