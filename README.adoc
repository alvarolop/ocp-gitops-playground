...
==== #1: Enabling the OpenShift integrated login
...
==== #1: Using namespace Isolation at cluster level (Service Account)
...
==== #2: Using advanced RBAC configuration (SSO users)
